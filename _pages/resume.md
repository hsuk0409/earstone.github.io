...
- **인프라 아키텍처 개선 및 데브옵스 환경 구축 (2025.11 - 2026.01)**
  ...
  - NestJS 환경에 Winston 및 New Relic을 연동하여 중앙 집중형 로깅 및 실시간 모니터링 시스템을 구축, 장애 대응 체계 마련.
- **학원 관리 프로그램 개발 및 서버 구축 (2025.03 - 진행중)**
